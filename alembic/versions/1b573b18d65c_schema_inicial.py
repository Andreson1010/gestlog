...
Revision ID: 1b573b18d65c
Revises: 
Create Date: 2026-09-11 16:28:23.223157
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('tenant_id', 'sku', name='uq_stock_tenant_sku')
    )
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('tenant_id', 'fornecedor_id', name='uq_supplier_tenant')
    )
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('tenant_id', 'codigo_rastreio', name='uq_transport_tenant')
    )
