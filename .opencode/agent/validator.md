...
|---|---|---|
| Retry on external call failure | `src/<package>/module.py:34` | Covered |
| Empty-result / no-op path | `src/<package>/module.py:84` | Covered |
| Boundary validation | `src/<package>/module.py:116` | Covered |
