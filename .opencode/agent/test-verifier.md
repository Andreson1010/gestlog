...
Check AGENTS.md for testing conventions. General rules:
...
- Test empty/zero-result edge cases explicitly
- Use pytest fixtures and parametrize where appropriate
- Test names follow the `test_*` pattern (module-level functions or `Test*` classes)
- Synthetic data only — never real or personal data
